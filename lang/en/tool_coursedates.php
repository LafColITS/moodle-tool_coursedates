...
$string['setdatesinstruction'] = 'Set the start and end dates for all courses in a category, including subcategories. Existing startdates or enddates won\'t be overwritten. Choose your options and click "Confirm". On confirmation, Moodle will create an "adhoc task" to set all the dates in the background. This requires that cron be enabled.';
